...
import (
	...
	"github.com/hauntedness/giom/utils"
)
...
type (
	DatabaseStorageChangedEventData struct{}
	AccountsChangedEventData        struct{}
	AccountChangedEventData         struct{}
	ContactsChangeEventData         struct{ AccountPublicKey string }
	MessagesCountChangedEventData   struct {
