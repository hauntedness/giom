...
func NewSnackBar(manager api.Manager) api.Snackbar {
	return &snackBar{
		manager:  manager,
		theme:    manager.Theme(),
		duration: 3000,
...
func (s *snackBar) Layout(gtx layout.Context) (d layout.Dimensions) {
			...
			d = inset.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
				...
				return flex.Layout(gtx,
					...
					layout.Rigid(func(gtx layout.Context) layout.Dimensions {
						...
						return material.Clickable(gtx, s.actionButton, func(gtx layout.Context) layout.Dimensions {
