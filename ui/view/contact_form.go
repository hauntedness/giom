...
func NewContactForm(manager api.Manager, contact service.Contact, OnSuccess func(addr string)) *contactForm {
...
func (p *contactForm) Layout(gtx layout.Context) layout.Dimensions {
	if p.Theme == nil {
...
func (p *contactForm) drawNewChatTextField(gtx layout.Context) layout.Dimensions {
