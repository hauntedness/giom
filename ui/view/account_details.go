...
func NewAccountDetails(manager api.Manager, account service.Account) *AccountDetails {
...
func (ad *AccountDetails) Layout(gtx layout.Context) layout.Dimensions {
	if ad.Theme == nil {
...
func (ad *AccountDetails) drawPasswordField(gtx layout.Context) layout.Dimensions {
...
func (ad *AccountDetails) drawPvtKeyField(gtx layout.Context) layout.Dimensions {
...
func (ad *AccountDetails) drawPubKeyField(gtx layout.Context) layout.Dimensions {
