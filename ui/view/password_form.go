...
func NewPasswordForm(manager api.Manager, OnSuccess func()) *passwordForm {
...
func (p *passwordForm) Layout(gtx layout.Context) layout.Dimensions {
	if !p.initialized {
...
func (p *passwordForm) drawPasswordTextField(gtx layout.Context) layout.Dimensions {
