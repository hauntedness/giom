...
func (p *page) Layout(gtx layout.Context) layout.Dimensions {
	...
	if p.btnAddContact.Clicked() {
		p.Modal().Show(p.drawAddContactModal, nil, component.VisibilityAnimation{
			Duration: time.Millisecond * 250,
			State:    component.Invisible,
			Started:  time.Time{},
		})
...
func (p *page) DrawNormalAppBar(gtx layout.Context) layout.Dimensions {
	th := p.Theme
...
func (p *page) DrawSelectionAppBar(gtx layout.Context) layout.Dimensions {
	th := p.Theme
...
func (p *page) drawContactsItems(gtx layout.Context) layout.Dimensions {
	...
	return p.List.Layout(gtx, len(p.contactsView), func(gtx layout.Context, index int) (d layout.Dimensions) {
...
func (p *page) drawMenuLayout(gtx layout.Context) layout.Dimensions {
	...
	layout.Stack{Alignment: layout.NE}.Layout(gtx,
		layout.Stacked(func(gtx layout.Context) layout.Dimensions {
			return p.btnBackdrop.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
...
func (p *page) drawNormalMenuItems(gtx layout.Context) layout.Dimensions {
	...
	if p.btnDeleteAll.Clicked() {
		p.selectAll()
		p.Modal().Show(p.drawDeleteContactsModal, nil, component.VisibilityAnimation{
			Duration: time.Millisecond * 250,
			State:    component.Invisible,
			Started:  time.Time{},
		})
...
func (p *page) drawSelectionMenuItems(gtx layout.Context) layout.Dimensions {
...
func (p *page) drawAddContactModal(gtx layout.Context) layout.Dimensions {
...
func (p *page) drawDeleteContactsModal(gtx layout.Context) layout.Dimensions {
	gtx.Constraints.Max.X = int(float32(gtx.Constraints.Max.X) * 0.85)
	gtx.Constraints.Max.Y = int(float32(gtx.Constraints.Max.Y) * 0.85)
	if p.btnYes.Clicked() {
...
func (p *page) fetchContactsOnScroll(_ layout.Context) {
